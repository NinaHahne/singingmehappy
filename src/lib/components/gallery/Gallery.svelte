...
<section class="gallery content-wrapper">
  <section class="content-section relative">
    <div
      class="left-col left-col-smaller menu-shadow sticky top-20 z-10 -mb-[1lh] mr-[1em] self-end text-right text-6xl leading-none lg:top-[calc(50dvh-0.5em)] lg:my-[35px] lg:mr-0 lg:self-start lg:text-[100px] xl:text-[120px]"
    >
